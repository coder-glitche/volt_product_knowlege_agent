...
- 
    ...
    **A) Referrer User flow: Discovery → Share → Track → Unlock reward (Referee loan account opening success) → Claim reward**
    ...
    - **Landing page:**
        ...
        - [Tracker](Referral%20Product%20Note%20(1)%202e7e8d3af13a807ab9a1fe10c4c8527d.md) for referrals and rewards (with entry point for detailed tracking of all referrals and rewards unlocked with current status)
        - Milestone levels tracker with reward (no. of completed/ total milestone steps)
        - T&C link
            
            [Key **Terms & Conditions** for 1st referral program**:**](Referral%20Product%20Note%20(1)%202e7e8d3af13a807ab9a1fe10c4c8527d.md) 
            
        - [Validity period of r](Referral%20Product%20Note%20(1)%202e7e8d3af13a807ab9a1fe10c4c8527d.md)eferral program
    ...
    - **Tracking mechanism details:**
        ...
        - **Rewards**
            - Tracking of Unlocked rewards (across their lifecycle): Rewards which get unlocked on completion of each successful referral.
                - Overall view of ‘Total rewards’ (Sum of cash amount + Physical) unlocked  for ‘Cash + Physical’ rewards. The details will be subdivided into following 2 sections:
                    1. Total ‘Cash rewards’ (Sum of cash amounts) earned view which are in “[active](Referral%20Product%20Note%20(1)%202e7e8d3af13a807ab9a1fe10c4c8527d.md) “status with “Claim” action. This will further include:
        ...
        **Claiming journey and mechanism:**
        ...
        1. Cash reward claim:
            ...
            - **Admin action:**
                ...
                - Post fulfilment is successful, Ops team will manually update the sheet with delivery_status column and upload it in the same [format](Referral%20Product%20Note%20(1)%202e7e8d3af13a807ab9a1fe10c4c8527d.md) as downloaded via admin action.
        ...
        **Reward Tracking and claiming mechanism:**
        ...
        - The [tracking](Referral%20Product%20Note%20(1)%202e7e8d3af13a807ab9a1fe10c4c8527d.md) details of rewards, notification channel with status of reward, expiry date and [claiming](Referral%20Product%20Note%20(1)%202e7e8d3af13a807ab9a1fe10c4c8527d.md) flow will be same as referrer as it is a cash reward.
