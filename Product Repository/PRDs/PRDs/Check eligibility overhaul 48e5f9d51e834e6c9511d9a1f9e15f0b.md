...
: Saksham Srivastava
Created time: February 14, 2024 5:27 PM
Status: Not started
Last edited: February 22, 2024 8:34 AM
Owner: Saksham Srivastava

[Template (Duplicate this for new PRDs)](Check%20eligibility%20overhaul/Template%20(Duplicate%20this%20for%20new%20PRDs)%20bd830a4f12194e61bad18301ccd8f705.md)
...
Sections to be shown on eligibility landing page (Before user checks eligibility): 
NSM for the page: “Check eligibility” conversion

| Section | Content | What user problem is it solving? |
| --- | --- | --- |
| Interest comparison | - Comparison with auto, personal, business loan and credit card
- Clear UI+copy distinction on volt interest rate | User wants to compare volt with other available options for credit.  |
