# Mobile/email dedupe check in case on in-progress mobile/email update

: Ameya Aglawe
Created time: December 23, 2024 4:22 PM
Status: Pending Review
Last edited: December 25, 2024 6:42 PM
...
- This results in complications such as:
    - Ambiguity about which account the user should access when logging in with P2.
    - Poor user experience and potential operational challenges.

---

# **How do we measure success?**

- Number of accounts with same mobile number should be 0
- Number of accounts with same email ID should be 0
...
- Action for each of these routes
    ...
    - Login through SDKs - Throw an error in the createCustomer/getCustomer API
        ...
        ```jsx
        {
            "message": "Lead with the same mobile number exists",
            "statusCode": "400"
        }
        ```
...
- When a user verifies an email during application creation, the system must include an additional check to identify emails with pending update requests.
