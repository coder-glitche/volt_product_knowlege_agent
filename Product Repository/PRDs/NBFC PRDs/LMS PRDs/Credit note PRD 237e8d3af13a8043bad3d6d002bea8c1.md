...
Last Edited: August 22, 2025 11:40 AM
...
- Get charge details: (Stretchy report to be built via Finflux: In progress)
    - Amount
...
- Validate if the charge is paid
...
![image.png](Credit%20note%20PRD/image.png)

Checker task:

Approve charge refund

![image.png](Credit%20note%20PRD/image%201.png)
